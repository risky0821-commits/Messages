...
class ArchivedConversationsAdapter(
    ...
    private fun deleteConversations() {
        ...
        val conversationsToRemove = currentList.filter { selectedKeys.contains(selectionKey(it)) } as ArrayList<Conversation>
    ...
    private fun unarchiveConversation() {
        ...
        ensureBackgroundThread {
            val conversationsToUnarchive = currentList.filter { selectedKeys.contains(selectionKey(it)) } as ArrayList<Conversation>
    ...
    private fun removeConversationsFromList(removedConversations: List<Conversation>) {
        ...
        activity.runOnUiThread {
            if (newList.none { selectedKeys.contains(selectionKey(it)) }) {
